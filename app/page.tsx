...
import { TrendingUp, TrendingDown, Wallet, Users, Package, Warehouse, Calendar } from "lucide-react";
      ...
      <header className="bg-[#0f172a] text-white p-6 shadow-xl mb-8">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
             {/* الزرار دلوقتي بينقلك لصفحة التقارير المستقلة */}
             <Link 
               href="/reports"
               className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-black text-sm shadow-lg transition-all active:scale-95 border border-indigo-400/20 flex items-center gap-2"
             >
               <Calendar size={18} />
               📅 تقارير الحسابات
             </Link>
             <div className="bg-white/10 px-4 py-2 rounded-xl text-center border border-white/5 hidden md:block">
