      ...
      <header className="bg-[#0f172a] text-white p-6 shadow-xl mb-8 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto flex justify-between items-center flex-wrap gap-4">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-500 px-6 py-3 rounded-xl font-black text-sm transition-all active:scale-95 shadow-lg shadow-indigo-900/30"
          >
            ➕ إضافة مورد
          </button>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div
            ...
            className={`p-5 rounded-[2rem] shadow-sm cursor-pointer transition-all border-2 ${filterDebt === "debtors" ? "bg-rose-500 text-white border-rose-500" : "bg-white border-slate-200 hover:border-rose-300"}`}
          >
          ...
          <div
            ...
            className={`p-5 rounded-[2rem] shadow-sm cursor-pointer transition-all border-2 ${filterDebt === "clear" ? "bg-emerald-500 text-white border-emerald-500" : "bg-white border-slate-200 hover:border-emerald-300"}`}
          >
              ...
              <tbody className="divide-y divide-slate-50">
                {displayed.map(s => (
                  <tr key={s.id} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="p-5 text-slate-400 font-bold text-sm">{s.phone || "—"}</td>
                    <td className="p-5">
                      {s.balance > 0 ? (
